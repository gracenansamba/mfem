...
#define MFEM_COMM_REGION_BEGIN(s) CALI_MARK_COMM_REGION_BEGIN(s)
#define MFEM_COMM_REGION_END(s) CALI_MARK_COMM_REGION_END(s)
...
#define MFEM_PERF_SCOPE(name)
#define MFEM_COMM_REGION_BEGIN(s)
#define MFEM_COMM_REGION_END(s)
